...
async function loadDashboardData() {
    try {
        ...
        // Also load mobile view data if mobile view is active
        if (window.mobileViewUtils && window.mobileViewUtils.isMobileViewActive()) {
            // Mobile view data will be loaded by mobile-view.js
        }
    } catch (error) {
